        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
            {latestKits.length ? latestKits.map((kit) => (
              <Link key={kit.id} href={`/biblioteca/${kit.slug}`} className="group overflow-hidden rounded-2xl border border-white/15 bg-gradient-to-b from-white/10 to-white/5 shadow-[0_18px_40px_rgba(8,145,178,0.18)] transition hover:scale-[1.02] hover:border-cyan-200/80">
                <div className="relative">
