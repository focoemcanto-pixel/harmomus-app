...
import { Music2, PlayCircle, SlidersHorizontal, Sparkles, UserRound } from "lucide-react";
...
function HarmomusBrand({ logoUrl }: { logoUrl?: string | null }) {
  if (logoUrl) {
    return <img src={logoUrl} alt="Harmomus" className="h-16 w-auto object-contain" />;
  }
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <p className="text-4xl font-black tracking-tight text-white">Harmo<span className="text-violet-300">mus</span></p>
    </div>
  );
}
